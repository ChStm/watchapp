...
/* 4 */
/*!**********************************************************************!*\
  !*** E:/B/JavaPro/watchapp/watchapp_front/watchapp-front/pages.json ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 7 */
/*!***************************************************************************************!*\
  !*** E:/B/JavaPro/watchapp/watchapp_front/watchapp-front/pages.json?{"type":"style"} ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": { "navigationBarTitleText": "uni-app" }, "pages/order/order": {}, "pages/my/my": {}, "pages/home/home": {}, "pages/my/login/login": {} }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "uni-app", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#F8F8F8" } };exports.default = _default;

/***/ }),
/* 8 */
/*!**************************************************************************************!*\
  !*** E:/B/JavaPro/watchapp/watchapp_front/watchapp-front/pages.json?{"type":"stat"} ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__BD739EE" };exports.default = _default;
...
/* 15 */
/*!*************************************************************************************!*\
  !*** E:/B/JavaPro/watchapp/watchapp_front/watchapp-front/common/user-info-utils.js ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var LOGIN_USER_INFO = 'LOGIN_USER_INFO'; //用户的key
function updateUserInfo(refreshInfo) {
  var userInfo = getUserInfo();
  userInfo.accessToken = refreshInfo['access_token']; //access_token
  userInfo.expiresIn = refreshInfo['expires_in']; //超时时长,一般是十分钟
  userInfo.lastLoginDatetime = new Date(); //更新最后登录时间
...
/* 16 */
/*!*********************************************************************************!*\
  !*** E:/B/JavaPro/watchapp/watchapp_front/watchapp-front/common/login-utils.js ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _api = _interopRequireDefault(__webpack_require__(/*! @/common/api.js */ 17));
var _userInfoUtils = _interopRequireDefault(__webpack_require__(/*! @/common/user-info-utils.js */ 15));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
function checkTokenValidity() {
  var userInfo = _userInfoUtils.default.getUserInfo(); //获取用户信息
  return new Promise(function (resolve, reject) {
    if (userInfo && userInfo.expiresIn && userInfo.lastLoginDatetime) {
      ...
      //用当前时间和登录时间相减，如果超时就需要重新登录
      if (currentDatetime - userInfo.expiresIn * 1000 > lastLoginDatetime) {
        console.log('token expire');
        // openLoginPage()
        // reject(refreshAccessToken())
        refreshAccessToken() //刷新登录权限
        .then(function (res) {
          _userInfoUtils.default.updateUserInfo(res.data); //更新用户数据
          console.log('refreshAccessToken success');
          resolve();
        }).
        catch(function (res) {
          console.log('refreshAccessToken fail'); //有效期内，不需要重新登录
          reject();
        });
      } else {
        resolve();
...
/* 17 */
/*!*************************************************************************!*\
  !*** E:/B/JavaPro/watchapp/watchapp_front/watchapp-front/common/api.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 18));var _loginUtils = _interopRequireDefault(__webpack_require__(/*! @/common/login-utils.js */ 16));
var _userInfoUtils = _interopRequireDefault(__webpack_require__(/*! @/common/user-info-utils.js */ 15));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _slicedToArray(arr, i) {return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _nonIterableRest();}function _nonIterableRest() {throw new TypeError("Invalid attempt to destructure non-iterable instance");}function _iterableToArrayLimit(arr, i) {var _arr = [];var _n = true;var _d = false;var _e = undefined;try {for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) {_arr.push(_s.value);if (i && _arr.length === i) break;}} catch (err) {_d = true;_e = err;} finally {try {if (!_n && _i["return"] != null) _i["return"]();} finally {if (_d) throw _e;}}return _arr;}function _arrayWithHoles(arr) {if (Array.isArray(arr)) return arr;}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}
...
var defaultSetting = {
  ...
  datatype: 'json',
  isLocalResult: true, //RestResult,statusCode==200&&data.code==200
  isApiRequest: false //true:?access_toiken=xx,false/
};
...
function sendRequest(options) {
  //Promise对象，处理异步请求问题
  return new Promise( /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(resolve, reject) {var _ref2, _ref3, error, res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (

                uni.request(options));case 2:_ref2 = _context.sent;_ref3 = _slicedToArray(_ref2, 2);error = _ref3[0];res = _ref3[1]; //解决异步请求，线程安全问题
              ...
              !options.isLocalResult && checkResponseSuccess(res)) {
                ...
                reject(res);
              }case 7:case "end":return _context.stop();}}}, _callee, this);}));return function (_x, _x2) {return _ref.apply(this, arguments);};}());
...
function initOptions(options) {
  if (options) {
    ...
    //自动拼接完baseUrl以后的结果http://localhost:90/login
    options.url = (options.baseUrl ? options.baseUrl : '') + (
    options.url ? options.url : opdefaultSetting.url);
    ...
    if (options.isApiRequest) {
      options.data['access_token'] = _userInfoUtils.default.getAccessToken(); //调用user-info-utils.js里面的方法获取access_token
    } else {
